...
const STORAGE_KEY_ACCOUNTS = 'adoptluck_roblox_accounts_v5';
const STORAGE_KEY_SESSION = 'adoptluck_auth_session_v5';
const STORAGE_KEY_PET_VALUES = 'adoptluck_pet_values_v5';
const STORAGE_KEY_PLAYER_PETS = 'adoptluck_player_inventories_v5';
...
export function getPlayerPets(username: string): PlayerPetItem[] {
  ...
  // New accounts start with an empty inventory. Pets must be assigned by the platform/admin.
  ...
  // If all were fake and stripped, re-populate with real starter pets
